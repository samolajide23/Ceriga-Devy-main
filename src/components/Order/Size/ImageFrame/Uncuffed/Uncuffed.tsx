...
import styles from "./uncuffed.module.scss";
...
const UncuffedSize: FC<IImageFrame> = ({
  activeChar,
  ...
  return (
    <div className={pants_1}>
      <img
        src="/img/productsSize/Sweat Pants uncuffed.jpg"
        alt="pants-1"
        className={img}
      />
      <div
      ...
      >
        ...
        <span
          className={`${arrowhead} ${arrow_b_c_head} ${
            activeChar === "B" || activeChar === "C"
              ? active_arrowhead_border
              : ""
          }`}
        ></span>
