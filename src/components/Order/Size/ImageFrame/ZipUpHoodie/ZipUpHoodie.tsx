...
import styles from "./zipUpHoodie.module.scss";
...
const ZipUpHoodieSize: FC<IImageFrame> = ({
  activeChar,
  ...
  return (
    <div className={jacket}>
      <img
        src="/img/productsSize/Zip Up Hoodie.jpg"
        alt="Zip Up Hoodie"
        className={img}
      />
      <div
      ...
      <div
        className={`${line} ${arrow_i_first} ${
          activeChar === "I" ? active_line : ""
        }`}
        onClick={() => handleChangeActiveChar("I")}
      >
        <span
          className={`${letter_wrap} ${arrow_i_first_letter} ${
        ...
        <span
          className={`${arrowhead} ${arrow_i_first_head} ${
            activeChar === "I" ? active_arrowhead_border : ""
          }`}
        ></span>
      </div>
      <div
        className={`${line} ${arrow_i_sec} ${
          activeChar === "I" ? active_line : ""
        }`}
        onClick={() => handleChangeActiveChar("I")}
      >
        <span
          className={`${letter_wrap} ${arrow_i_sec_letter} ${
            activeChar === "I" ? active_letter : ""
          }`}
        >
          I
        ...
        <span
          className={`${arrowhead} ${arrow_i_sec_head} ${
            activeChar === "I" ? active_arrowhead_border : ""
          }`}
        ></span>
      </div>
      <div
        className={`${line} ${arrow_j} ${
          activeChar === "J" && active_line_border
        }`}
      >
        <span
      ...
      >
        ...
        <span
          className={`${arrowhead} ${arrow_k_head} ${
...
export default ZipUpHoodieSize;
